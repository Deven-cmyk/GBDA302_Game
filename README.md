...
data/blocks.json
assets/images/  (wall.png, corner.png, floor.png, mainguy2.png, Vampire.png, key.png, table.png, death.png)
assets/sounds/  (scarymusic.mp3, whisper.mp3)
```

| File                          | Purpose                                                  | Source                                       |
| ----------------------------- | -------------------------------------------------------- | -------------------------------------------- |
| `assets/sounds/scarymusic.mp3`| Quiet, muffled background score (looped).                | https://youtu.be/7ifWmw6U2dE?si=sjZFYGp-G1oG_V4K |
| `assets/sounds/whisper.mp3`   | Vampire whisper, looped, volume scales with proximity.   | https://www.youtube.com/watch?v=7JOEKMiHJn0  |
